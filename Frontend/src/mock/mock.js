...
function countUserNum() {
    const a = Mock.mock({
        success: true,
        data: {
            offlineNum:'@integer(2000, 3000)',
            lockNum: '@integer(3000, 5000)',
            totalNum:9286
        }
    })
...
function installationPlan() {
    ...
    for (let index = 0; index < num; index++) {
        ...
        let rate = lineNum - a.barData[index];
        rateData.push(rate)
...
Mock.mock(new RegExp('wordCloud'), 'get', wordCloud)
